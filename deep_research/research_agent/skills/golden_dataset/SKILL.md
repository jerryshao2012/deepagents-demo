...
- Include `context` for every item. This should be the supporting RAG content that best matches the question and answer and will be used later for meaningful `Groundedness` evaluation.
...
[
  ...
  { "type": "repeat", "path": "items", "body": [
    ...
    { "type": "text", "value": "Content: {item.context}" }
  ]},
