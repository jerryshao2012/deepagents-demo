...
# With Ollama
python ralph_mode.py "Build a Python course" --model ollama:glm-4.7-flash:latest

# With Cloud API (default)
...
# With specific model
python ralph_mode.py "Create a CLI tool" --model ollama:qwen3.5:latest
